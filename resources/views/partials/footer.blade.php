      ...
      <div class="col-sm-4 text-center">
        <div class="info-box">
          ...
          <ul class="text-center">
            ...
            <li>LandlordsNG Lagos, Nigeria</li>
          </ul>
        </div>
      </div>
      <div class="col-sm-4 text-center">
        <div class="info-box">
          ...
          <ul class="text-center">
            ...
            <li><a href="#.">info@landlordsng.com</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-3 col-sm-6">
        <div class="footer_panel bottom30">
          ...
          <p class="bottom15">If you are interested in landlordsng do not wait to <a href="#.">SIGNUP NOW!</a></p>
        </div>
      </div>
      <div class="col-md-3 col-sm-6">
        <div class="footer_panel bottom30">
    ...
    <div class="copyright_simple">
      <div class="row">
        <div class="col-md-6 col-sm-5 top20 bottom20">
          <p>Copyright &copy; 2020 <span>LandlordsNG</span>. All rights reserved.</p>
        </div>
