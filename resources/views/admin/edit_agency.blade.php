                ...
                <div class="col-lg-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <h4 class="mt-0 header-title">Edit Agency</h4>
                            ...
                            <form action="edit_agency" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control"
                                                    data-parsley-minlength="6" value="{{$agency->facebook}}" name="facebook"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Twitter</label>
                                            <div>
                                                <input type="text" class="form-control"
                                                    data-parsley-minlength="6" value="{{$agency->twitter}}" name="twitter"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control"
                                                    data-parsley-minlength="6" value="{{$agency->instagram}}" name="instagram"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Website</label>
                                            <div>
                                                <input type="text" class="form-control"
                                                    data-parsley-minlength="6" value="{{$agency->website}}" name="website" />
                                            </div>
                                        </div>
                                    </div>
